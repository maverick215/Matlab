...
yi_ts1 = interp1(samples./2, ts1, 1.5:1:length(ts1), 'v5cubic'); % Samples need to be set back to actual #samples; 1.5:1: ensures we predict the right middle values by interpolation
...
yi_2 = interp1(sampleInstants, reducedSamples, 2:3:length(originalSamples), 'v5cubic');
...
%interpolating for positions 2,5,8.....
yi_3 = interp1(sampleInstants, reducedSamples, 3:3:length(originalSamples), 'v5cubic');
% The last element in this series containing the result of interpolation has to be removed if we were required to extend the
% original series earlier
...
yi_2 = interp1(sampleInstants, reducedSamples, 2:4:length(originalSamples),'v5cubic');
...
yi_3 = interp1(sampleInstants, reducedSamples, 3:4:length(originalSamples), 'v5cubic');
% The last element in this series containing the result of interpolation has to be removed if we were required to extend the
% original series earlier
...
yi_4 = interp1(sampleInstants, reducedSamples, 4:4:length(originalSamples), 'v5cubic');
% The last element in this series containing the result of interpolation has to be removed if we were required to extend the
% original series earlier
...
yi_2 = interp1(sampleInstants, reducedSamples, 2:5:length(originalSamples), 'v5cubic');
...
yi_3 = interp1(sampleInstants, reducedSamples, 3:5:length(originalSamples), 'v5cubic');
% The last element in this series containing the result of interpolation has to be removed if we were required to extend the
% original series earlier
...
yi_4 = interp1(sampleInstants, reducedSamples, 4:5:length(originalSamples), 'v5cubic');
% The last element in this series containing the result of interpolation has to be removed if we were required to extend the
% original series earlier
...
yi_5 = interp1(sampleInstants, reducedSamples, 5:5:length(originalSamples), 'v5cubic');
% The last element in this series containing the result of interpolation has to be removed if we were required to extend the
% original series earlier
